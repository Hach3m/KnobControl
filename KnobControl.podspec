...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "hachem" => "hachembouajila@gmail.com" }
  # Or just: spec.author    = "hachem"
  # spec.authors            = { "hachem" => "hachembouajila@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/hachem"
  ...
  spec.source       = { :git => "https://github.com/Hach3m/KnobControl.git", :tag => "1.0.0" }
